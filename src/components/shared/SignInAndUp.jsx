...
<div className="mb-6  relative">
              <div className="w-[80px] h-[80px] mx-auto rounded-full overflow-hidden group">
                <Image height={676} width={1200}
                  src={selectedImage || "https://i.postimg.cc/xTmfVLXn/download-black-male-user-profile-icon-png-701751695035033bwdeymrpov.png"}
                  ...
                  alt="logo"
                />
                <div onChange={handleImageChange} className="absolute w-[80px] h-[80px] mx-auto rounded-full inset-0 bg-black bg-opacity-50 group-hover:opacity-100 flex items-center justify-center opacity-0  transition-opacity duration-300">
