    ...
    <section className="container  ">
      <div className="relative bg-white rounded-md">
        <Image
          ...
          alt="featured books"
          className="h-[360px] w-full pb-[160px] "
        ></Image>
        ...
        <div className="flex items-center gap-3 absolute bottom-[30px] left-11">
          <Image
            ...
            alt="featured books"
            className="h-[190px] w-[190px] rounded-full border-[4px] "
          ></Image>
      ...
      <div className="bg-white mt-[10px] pt-6 px-5 rounded-md">
        <div className="flex items-center justify-between text-gray-500">
          <p>Tota Result {attributeBooks?.totalBooks}</p>
          <span className="relative   ">
            <input
              onKeyUp={handleSearch}
              type="text"
              placeholder="Search Anything"
              className="  bg-bg-gray  md:w-[200px] lg:w-[300px] py-3  px-2 border-none focus:outline-none focus:border-none  rounded-md  "
            />
            <FaSearch
              size={22}
