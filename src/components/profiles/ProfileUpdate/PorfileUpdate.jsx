...
function ProfileUpdate() {
  ...
  const handleSubmit = async (e) => {
    ...
    const newObj = { name, day, month, year, phoneNumber, gender, photo: imageUrl || data?.photo }
  ...
  return (
    <Tabs   >
      <TabList>
        <Tab><h2 className="text-base font-semibold">Personal Information</h2></Tab>
        <Tab><h2 className="text-base font-semibold">Password </h2></Tab>
      </TabList>
            ...
            <div className="mb-6  relative">
              <div className="w-36 h-36 mx-auto rounded-full overflow-hidden group">
                <Image height={676} width={1200}
                  src={selectedImage || data?.photo || "https://i.postimg.cc/xTmfVLXn/download-black-male-user-profile-icon-png-701751695035033bwdeymrpov.png"}
                  ...
                  alt="logo"
                />
                <div onChange={handleImageChange} className="absolute w-36 h-36 mx-auto rounded-full inset-0 bg-black bg-opacity-50 group-hover:opacity-100 flex items-center justify-center opacity-0  transition-opacity duration-300">
                  ...
                  <input
                    ...
                    onChange={async (e) => {
                      console.log("onchange er moddhe image file", e.target.files?.[0])
