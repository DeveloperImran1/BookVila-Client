  ...
  return (
    <div className="p-2 w-full md:w-[80%] ">
      <form onSubmit={handleSubmit}>
        <div className="mt-4 ">
          <label htmlFor="oldPass" className="block font-medium mb-1">
            Old Password
          </label>
          <input
            type="password"
            ...
            className="border-2 rounded-md px-3 py-2 w-full  transition-all duration-300 focus:outline-none "
          />
        </div>
        <div className="mt-4">
          <label htmlFor="newPass" className="block font-medium mb-1">
            New Password
          </label>
          <input
            type="password"
        ...
        <div className="mt-4">
          <label htmlFor="confirmPass" className="block font-medium mb-1">
            Confirm Password
          </label>
          <input
            type="password"
        ...
        <div className="flex  justify-end">
          <button
            type="submit"
            disabled={
              !formData.oldPass || !formData.newPass || !formData.confirmPass
            }
            className={`${
              !formData.oldPass || !formData.newPass || !formData.confirmPass
