      ...
      <article className="rounded-md border-2 p-4 w-full space-y-3 relative bg-white">
        ...
        <div className="hover:scale-110 transition delay-900 cursor-pointer flex flex-col justify-center items-center">
          <Image
            ...
            alt="book"
            className="w-[180px] h-[250px] my-4 rounded-md"
          />
        </div>
        ...
        <h1 className="text-3xl font-semibold">{book?.bookName[0]}</h1>
        ...
        <div className="flex justify-between items-center">
          <div className="flex gap-4 items-center">
            <h2 className="text-[17px] font-semibold">{originalPrice}</h2>
            <del className="text-[17px] hidden md:block font-semibold text-gray-600">
              {newPrice.toFixed(2)}
            </del>
          </div>
