            ...
            >
              <div className="w-full flex flex-col justify-center items-center ">
                <Image
                  src={
                    selectedImage ||
                    "https://i.postimg.cc/GtsM2qQ0/pngtree-educational-learning-books-png-image-3851016.jpg"
                  }
                  height={500}
                  width={1200}
                  alt="Profile Image"
                ...
                >
                  <label
                    className="flex h-full w-max items-end gap-4 rounded-md bg-cyan-500 px-6 py-4 text-white active:ring-4 "
                    htmlFor="file"
                  >
                    <svg
                      width={30}
                    ...
                    <p className="text-lg font-medium text-white">
                      {" "}
                      {showName.name ? showName?.name?.slice(0, 20) : "Upload"}
                    </p>
                  </label>
                  <input
                    type="file"
          ...
          <div className="">
            {myReview?.length < 1 && (
              <div className="flex flex-col items-center justify-center ">
                <Image
                  className="h-[270px] w-[280px] "
                  height={676}
                  width={1200}
                  src="https://i.postimg.cc/pVj1rn9D/360-F-106646110-Lv-Qrtj1uxmnse1g-GOIFv7-Gh-WSXFv-Z3lk-removebg-preview.png"
                  alt="gift"
                />
                <h3 className="text-[20px] font-semibold text-gray-500 my-5 ml-3">
                  This book have not any review 🤔
                </h3>
              </div>
            )}
          </div>
          ...
          {showAll
            ? myReview?.slice(0, 4)?.map((review) => (
                ...
                >
                  ...
                  {review?.bookPhoto?.length > 0 && (
                    <Swiper
                      modules={[]}
                      className="mySwiper border-2 w-[150px] rounded-md"
                    >
                      {review?.bookPhoto?.map((item, index) => (
            ...
            : myReview?.map((review) => (
                <div
                  key={review?._id}
                  className=" flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md shadow-md"
                >
        ...
        {myReview?.length > 4 && (
          <div className="w-full flex justify-center items-center">
            <button
              ...
              className="bg-primary text-white px-4 py-2  rounded-lg my-6 "
            >
