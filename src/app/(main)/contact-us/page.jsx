...
const ContactUs = () => {
    ...
    return (
        <div id="contact" className='container pt-[20px] md:pt-[33px] lg:pt-11'>
            ...
            <div className="  grid  grid-cols-1 gap-8 px-8 py-16 md:px-12 lg:px-16 xl:px-32 mx-auto rounded-lg md:grid-cols-2  bg-white  text-gray-800">
                <div className="flex flex-col justify-between">
                    ...
                    <Image height={1200} width={1200} src="https://i.ibb.co/Br9Fpxs/th-2-removebg-preview.png" alt="" className="lg:-ml-16 h-full" />
                </div>
                <form onSubmit={handleSubmit} noValidate="" className="space-y-6 ">
                    ...
                    >
                        ...
                        <input id="name" type="text" placeholder="Your name" className="w-full p-3 rounded  border-2 " />
                    </div>
                    <div
                        data-aos="fade-up"
                        data-aos-offset="200"
                    ...
                    >
                        ...
                        <input id="email" placeholder='Your email' type="email" className="w-full p-3 rounded border-2" />
                    </div>
                    <div
                        data-aos="fade-up"
                        data-aos-offset="200"
                    ...
                    >
                        ...
                        <textarea id="message" placeholder='Message...' rows="3" className="w-full p-3 rounded border-2"></textarea>
                    </div>
                    <button
                        data-aos="fade-up"
                        data-aos-offset="200"
                        ...
                        data-aos-easing="ease-in-out"
                        data-aos-mirror="true"
                        type="submit" className="w-full p-3 text-sm font-bold tracking-wide uppercase rounded bg-primary text-gray-50">Send Message</button>
                </form>
            </div>

            <div>
         
                <div className='flex flex-col lg:flex-row justify-between pt-[20px] md:pt-[33px] lg:pt-11' >
                    <div className='grid gap-7 grid-cols-2' >
                        <div className='w-[230px] h-[230px] cursor-pointer md:mr-4 rounded-3xl bg-white  hover:bg-[#076aa5] hover:text-white flex flex-col justify-center items-center transition-all delay-300' >
                            ...
                            <h2 className='text-[19px] font-bold group  dark:text-black' >Shariatpur</h2>
                            <h2 className='text-center px-3 mt-3 group ' >Shariatpur Sadar. Neat at Thakurgaon Polytechnic Institute</h2>
                        </div>
                        ...
                        <div className='w-[230px] h-[230px] cursor-pointer md:mr-4 rounded-3xl bg-white  hover:bg-[#076aa5] hover:text-white flex flex-col justify-center items-center transition-all delay-300' >
                            ...
                            <h2 className='text-[19px] font-bold group  dark:text-black' >Phone</h2>
                        ...
                        <div className='w-[230px] h-[230px] cursor-pointer md:mr-4 rounded-3xl bg-white  hover:bg-[#076aa5] hover:text-white flex flex-col justify-center items-center transition-all delay-300' >
                            ...
                            <h2 className='text-[19px] font-bold group  dark:text-black' >Email</h2>
                            <h2 className='text-center px-3 mt-3 group ' >bookvila.xyz@gmail.com</h2>
                        </div>
                        ...
                        <div className='w-[230px] h-[230px] cursor-pointer md:mr-4 rounded-3xl bg-white  hover:bg-[#076aa5] hover:text-white flex flex-col justify-center items-center transition-all delay-300' >
                            ...
                            <h2 className='text-[19px] font-bold group  dark:text-black' >Working Hours</h2>
                    ...
                    <div className=" h-full">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3667.635440218263!2d90.3874386305595!3d23.183502063489914!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x375511e6910abf39%3A0x20860e13c054d730!2z4Ka24Kaw4KeA4Kav4Ka84Kak4Kaq4KeB4KawIOCmquCmsuCmv-Cmn-Cnh-CmleCmqOCmv-CmlSDgpofgpqjgprjgp43gpp_gpr_gpp_gpr_gpongpp8!5e0!3m2!1sen!2sbd!4v1737373526060!5m2!1sen!2sbd" width="600" height="450"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
